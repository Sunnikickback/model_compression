...
def main():
    ...
    model_path = f"{model_config.model_type}_{model_config.task_type}.onnx"
    quantized_model_path = f"quantized_{model_config.model_type}_{model_config.task_type}.onnx"
